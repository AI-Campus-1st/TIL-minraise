...
-- 성적 테이블
StudentID: 홍길동의 StudentID(숫자), Math: 90, English: 80, Sceince: 50
StudentID: 이연걸의 StudentID(숫자), Math: 69, English: 76, Sceince: 65
StudentID: 이몽룡의 StudentID(숫자), Math: 98, English: 87, Sceince: 97
StudentID: 성춘향의 StudentID(숫자), Math: 87, English: 67, Sceince: 79
...
-- 실습 5-4) 성적 테이블에서 수학점수가 70점 미만인 학생의 점수를 70점으로 수정해 주세요.
